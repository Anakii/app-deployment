...
var users_schema_1 = require("../database/users/users.schema");
var AdminRoutes = /** @class */ (function () {
    function AdminRoutes() {
        ...
        this.addUser = (function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = new users_schema_1.UserModal({
                    ...
                    case 3:
                        err_1 = _a.sent();
                        res.json({ status: false, massage: "Faild to add user to db", err: err_1 });
                        return [3 /*break*/, 4];
    ...
    AdminRoutes.prototype.setRoutes = function () {
        this._router.get("/text", this.getText);
        this._router.post("/user", this.addUser);
    };
    Object.defineProperty(AdminRoutes.prototype, "router", {
        get: function () {
            return this._router;
        },
        enumerable: false,
